...
const App = () => {
  ...
  useEffect(() => {
    if (activeTab === "file") {
      setActiveAnalysisTab("metadata");
    } else if (activeTab === "email") {
      setActiveAnalysisTab("headers");
    }
    if (activeTab !== "url") {
      setUrlToCheck("");
  ...
  const fileAnalysisTabs = [
    { id: "metadata", label: "Metadata" },
    { id: "content", label: "Nội dung" },
    { id: "embedded", label: "Đối tượng nhúng" },
    { id: "static", label: "Hành vi tĩnh" },
  ];

  const handleResult = (data, featuresData) => {
    console.log("handleResult data:", data);
    console.log("handleResult featuresData:", featuresData);
    setTabResults((prev) => {
      const newResults = {
        ...prev,
        [activeTab]: { result: data, features: featuresData },
      };
      console.log("Updated tabResults:", newResults);
      return newResults;
    });
    setTriggerCheck(false);
    ...
    if (
      ...
      if (qrUrl) {
        setTabResults((prev) => ({
          ...prev,
          url: {
            result: { ...data.qr_results[0], url: qrUrl },
            ...
            <div className="flex flex-row space-x-4">
              <div className="w-1/2 p-4 bg-white dark:bg-gray-800 border rounded-lg shadow">
                {(activeTab === "url" ||
                  ...
                  <>
                    {activeTab === "url" &&
                      tabResults[activeTab].result.screenshot_url && (
                        <div className="mb-4">
                    ...
                    {activeTab === "file" && (
                      <>
                        ...
                        {tabResults[activeTab].result.file_details ? (
                          <>
                            <div className="mb-4">
                              <Tabs
                                tabs={fileAnalysisTabs}
                            ...
                            {activeAnalysisTab === "metadata" && (
                              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                                ...
                                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                  <li>
                                    <strong>Kích thước PDF:</strong>{" "}
                                    {tabResults[activeTab].features?.PdfSize
                                      ? `${Math.round(tabResults[activeTab].features.PdfSize * 100) / 100} KB`
                                      : <span className="italic text-gray-400">Không có</span>}
                                  </li>
                                  <li>
                                    <strong>Kích thước Metadata:</strong>{" "}
                                    {tabResults[activeTab].features?.MetadataSize
                                      ? `${tabResults[activeTab].features.MetadataSize} bytes`
                                      : <span className="italic text-gray-400">Không có</span>}
                                  </li>
                                  <li>
                                    <strong>Số trang:</strong>{" "}
                                    {tabResults[activeTab].features?.Pages || (
                                      <span className="italic text-gray-400">Không có</span>
                                    )}
                                  </li>
                                  <li>
                                    <strong>Tiêu đề:</strong>{" "}
                                    {tabResults[activeTab].features?.TitleCharacters
                                      ? `${tabResults[activeTab].features.TitleCharacters} ký tự`
                                      : <span className="italic text-gray-400">Không có</span>}
                                  </li>
                                  <li>
                                    <strong>Mã hóa:</strong>{" "}
                                    {tabResults[activeTab].features?.isEncrypted
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                </ul>
                              </div>
                            )}
                            {activeAnalysisTab === "content" && (
                              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                                ...
                                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                  <li>
                                    <strong>Kích thước văn bản:</strong>{" "}
                                    {tabResults[activeTab].features?.Text
                                      ? `${tabResults[activeTab].features.Text} ký tự`
                                      : <span className="italic text-gray-400">Không có</span>}
                                  </li>
                                  <li>
                                    <strong>Hình ảnh:</strong>{" "}
                                    {tabResults[activeTab].features?.Images
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                  <li>
                                    <strong>JavaScript:</strong>{" "}
                                    {tabResults[activeTab].features?.JS || tabResults[activeTab].features?.Javascript
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                  <li>
                                    <strong>Khóa mã hóa:</strong>{" "}
                                    {tabResults[activeTab].features?.Encrypt
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                </ul>
                            ...
                            {activeAnalysisTab === "embedded" && (
                              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                                ...
                                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                  <li>
                                    <strong>Tệp nhúng:</strong>{" "}
                                    {tabResults[activeTab].features?.EmbeddedFiles
                                      ? tabResults[activeTab].features.EmbeddedFiles
                                      : <span className="italic text-gray-400">Không có</span>}
                                  </li>
                                  <li>
                                    <strong>Đối tượng nhúng:</strong>{" "}
                                    {tabResults[activeTab].features?.EmbeddedFile
                                      ? tabResults[activeTab].features.EmbeddedFile
                                      : <span className="italic text-gray-400">Không có</span>}
                                  </li>
                                  <li>
                                    <strong>AcroForm:</strong>{" "}
                                    {tabResults[activeTab].features?.Acroform
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                  <li>
                                    <strong>XFA:</strong>{" "}
                                    {tabResults[activeTab].features?.XFA
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                </ul>
                            ...
                            {activeAnalysisTab === "static" && (
                              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                                ...
                                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                  <li>
                                    <strong>Hành động tự động mở:</strong>{" "}
                                    {tabResults[activeTab].features?.OpenAction
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                  <li>
                                    <strong>RichMedia:</strong>{" "}
                                    {tabResults[activeTab].features?.RichMedia
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                  <li>
                                    <strong>Launch:</strong>{" "}
                                    {tabResults[activeTab].features?.Launch
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                  <li>
                                    <strong>JBIG2Decode:</strong>{" "}
                                    {tabResults[activeTab].features?.JBIG2Decode
                                      ? "Có"
                                      : <span className="italic text-gray-400">Không</span>}
                                  </li>
                                </ul>
                            ...
                            <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                              {tabResults[activeTab].result.file_details?.urls === null ||
                                tabResults[activeTab].result.file_details?.urls.length === 0 ? (
                                <p className="text-md font-semibold text-gray-700 dark:text-white">
                                  Không phát hiện URL trong PDF
                                </p>
                              ) : (
                                <div>
                                  <p className="text-md font-semibold mb-2 text-gray-700 dark:text-white">
                                    Phát hiện URL trong PDF:
                                  </p>
                                  <ul className="space-y-2">
                                    {tabResults[activeTab].result.file_details.urls.map(
                                      (url, index) => (
                                        <li
                                          key={index}
                                        ...
                                        >
                                          ...
                                          <button
                                            onClick={() =>
                                              handleSwitchToURLCheck(url.Domain)
                                            }
                          ...
                          <p className="text-md font-semibold text-gray-700 dark:text-white">
                            Không có dữ liệu phân tích chi tiết cho tệp này
                          </p>
                        )}
                      </>)}
                            ...
                            <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                              ...
                              <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                <li>
                                  ...
                                  {tabResults[activeTab].result.email_details.x_headers["x-priority"] || (
                                    <span className="italic text-gray-400">None</span>
                                  )}
                                </li>
                                <li>
                                  <strong>X-MSMail-Priority:</strong>{" "}
                                  {tabResults[activeTab].result.email_details.x_headers["x-msmail-priority"] || (
                                    <span className="italic text-gray-400">None</span>
                                  )}
                                </li>
                                <li>
                                  <strong>X-OriginalArrivalTime:</strong>{" "}
                                  {tabResults[activeTab].result.email_details.x_headers["x-originalarrivaltime"] || (
                                    <span className="italic text-gray-400">None</span>
                                  )}
                                </li>
                              </ul>
                              ...
                              <div className="ml-4">
                                ...
                                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                  <li>
                                    ...
                                    {tabResults[activeTab].result.email_details.security.SPF.Result || (
                                      <span className="italic text-gray-400">None</span>
                                    )}
                                  </li>
                                  <li>
                                    <strong>Originating IP:</strong>{" "}
                                    {tabResults[activeTab].result.email_details.security.SPF.OriginatingIP || (
                                      <span className="italic text-gray-400">None</span>
                                    )}
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                    ...
                                    {tabResults[activeTab].result.email_details.security.SPF.ReturnPathDomain || (
                                      <span className="italic text-gray-400">None</span>
                                    )}
                                  </li>
                                  <li>
                                    <strong>SPF Record:</strong>{" "}
                                    {tabResults[activeTab].result.email_details.security.SPF.SPFRecord || (
                                      <span className="italic text-gray-400">None</span>
                                    )}
                                  </li>
                                </ul>
                                ...
                                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                  <li>
                                    <strong>Result:</strong>{" "}
                                    {tabResults[activeTab].result.email_details.security.DKIM.Result || (
                                      <span className="italic text-gray-400">None</span>
                                    )}
                                  </li>
                                  <li>
                                    <strong>Verifications:</strong>{" "}
                                    {tabResults[activeTab].result.email_details.security.DKIM.Verifications || (
                                      <span className="italic text-gray-400">None</span>
                                    )}
                                  </li>
                                </ul>
                                ...
                                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                  <li>
                                    <strong>Result:</strong>{" "}
                                    {tabResults[activeTab].result.email_details.security.DMARC.Result || (
                                      <span className="italic text-gray-400">None</span>
                                    )}
                                  </li>
                                  <li>
                                    <strong>From Domain:</strong>{" "}
                                    {tabResults[activeTab].result.email_details.security.DMARC.FromDomain || (
                                      <span className="italic text-gray-400">None</span>
                                    )}
                                  </li>
                                </ul>
                    ...
                    <div className="space-y-4">
                      ...
                      {tabResults[activeTab].result.third_party_eval?.googleSafeBrowsing && (
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {tabResults[activeTab].result.third_party_eval.googleSafeBrowsing.details || (
                              <span className="italic text-gray-400">None</span>
                            )}
                          </p>
                        </div>
                      )}
                      {tabResults[activeTab].result.third_party_eval?.urlVoid && (
                        <div
                          className={`p-4 rounded-lg ${getColorClass(
                            tabResults[activeTab].result.third_party_eval.urlVoid.status
                          )} border`}
                        >
                          <p className="text-md font-semibold text-gray-700 dark:text-white">
                            URLVoid:{" "}
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {tabResults[activeTab].result.third_party_eval.urlVoid.details || (
                              <span className="italic text-gray-400">None</span>
                            )}
                          </p>
                        </div>
              ...
              <div
                className={`${activeTab !== "image" ? "w-3/5" : "w-full"} p-4 bg-white dark:bg-gray-800 border rounded-lg shadow`}
              >
                ...
                {tabResults[activeTab].result.qr_results ? (
                      ...
                      >
                        ...
                        <div className="mt-3">
                          <p className="text-md text-gray-700 dark:text-gray-200">
                            Xác suất Phishing: <span className="font-bold text-lg">{qr.rf_confidence || 0}%</span>
                          </p>
                        ...
                        <div className="mt-3">
                          <p className="text-md text-gray-700 dark:text-gray-200">
                            Xác suất Hợp pháp: <span className="font-bold text-lg">{qr.legitimate_prob || 0}%</span>
                          </p>
                          <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                            <div
                  ...
                  <div>
                    <div
                      className={`p-4 rounded-lg mb-6 ${getColorClass(tabResults[activeTab].result.result)} border`}
                    >
                      <p className="text-lg font-semibold text-gray-800 dark:text-white">
                      ...
                      <div className="mt-3">
                        <p className="text-md text-gray-700 dark:text-gray-200">
                          Xác suất Phishing: <span className="font-bold text-lg">{tabResults[activeTab].result.rf_confidence || 0}%</span>
                        </p>
                        <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                          <div
                            className="bg-red-600 h-3 rounded-full"
                      ...
                      <div className="mt-3">
                        <p className="text-md text-gray-700 dark:text-gray-200">
                          Xác suất Hợp pháp: <span className="font-bold text-lg">{tabResults[activeTab].result.legitimate_prob || 0}%</span>
                        </p>
                        <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                          <div
                            className="bg-green-600 h-3 rounded-full"
                  ...
                  >
                    ...
                    {activeTab === "file" && tabResults[activeTab].result.filename && (
                      <p className="text-lg font-semibold text-gray-800 dark:text-white mb-2">
                        File: <span className="font-bold">{tabResults[activeTab].result.filename}</span>
                      </p>
                    )}
                    <p className="text-lg font-semibold text-gray-800 dark:text-white">
                      Phân loại:{" "}
