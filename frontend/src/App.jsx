...
const handleResult = (data, featuresData) => {
  ...
  // Chỉ chuyển sang tab URL nếu có mã QR
  if (
    activeTab === "image" &&
    data.qr_results &&
            ...
            <div className="flex flex-row space-x-4">
              <div className="w-2/5 p-4 bg-white dark:bg-gray-800 border rounded-lg shadow">
                {(activeTab === "url" ||
                  ...
                  <>
                      ...
                      tabResults[activeTab].result.email_details && (
                        <>
                          ...
                          {activeAnalysisTab === "received" && (
                            <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                              ...
                              <div className="space-y-4">
                                {tabResults[
                                  activeTab
                                ].result.email_details.received_lines.map(
                                  (hop, index) => (
                                    <div
                                      key={index}
                            ...
                            <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                              ...
                              <ul className="list-disc pl-5 text-gray-700 dark:text-gray-200">
                                ...
                                <li>
                                  ...
                                  {tabResults[activeTab].result.email_details
                                    .x_headers["x-originalarrivaltime"] || (
                                    <span className="italic text-gray-400">
                                      None
                                    </span>
                                  )}
                          ...
                          <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                            {tabResults[activeTab].result.email_details.urls ===
                              null ||
                            tabResults[activeTab].result.email_details.urls
                              .length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {tabResults[activeTab].result.third_party_eval
                        ?.virusTotal && (
                        <div
              ...
              >
                ...
                {tabResults[activeTab].result.qr_results ? (
                  <div>
                    {tabResults[activeTab].result.qr_results.map(
                      (qr, index) => (
                        <div
                          key={index}
                      ...
                      <div className="mt-3">
                        ...
                        <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3">
                          <div
                            ...
                            style={{
                              width: `${
                                tabResults[activeTab].result.legitimate_prob ||
                                0
                              }%`,
                            }}
                          ></div>
                  ...
                  >
                    {activeTab === "url" &&
                      tabResults[activeTab].result.url && (
                ...
                {tabResults[activeTab].features &&
                  !tabResults[activeTab].result.qr_results && (
                    <FeaturesDisplay
                      features={tabResults[activeTab].features}
                    />
                  )}
              </div>
            </div>
